...
export function modifyArticle(articleId, title, subtitle, date, paragraph0, image0, paragraph1, image1, paragraph2, image2, paragraph3, image3, visibility) {
    ...
    return fetch(`${import.meta.env.VITE_API_URL}/articles/${articleId}`, {
        method: 'PUT',
        headers: {
