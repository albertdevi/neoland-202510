...
function WazowskiEye() {
    return <div className='w-30 h-30 bg-white absolute left-15 top-10 rounded-full'>
...
function Wings() {
    return <div className='w-[37.5rem] h-0 bg-transparent absolute -left-50 bottom-0 border-t-[10rem] border-t-transparent border-b-[12.5rem] border-b-[lightgray] border-l-[12.5rem] border-l-transparent border-r-[12.5rem] border-r-transparent'></div>
}
