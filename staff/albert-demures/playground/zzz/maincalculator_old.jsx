        ...
        if (displayValue !== '0') {
            ...
            for (let i = displayValue.length - 1; i > 0; i--) {
                if (displayValue[i] !== '×' && displayValue[i] !== '÷' && displayValue[i] !== '+' && displayValue[i] !== '-') {
                    valor = valor[valor.length] + displayValue[i]
                }
                else {
                    return
                }
    ...
    return <div className="border-2 m-2 p-2 rounded-2xl bg-gray-800 text-white">
        ...
        <div className="p-2 flex flex-col gap-2">
            ...
            <div className='flex justify-between'>
                ...
                <div className="bg-orange-400 p-2 rounded-full w-10 h-10 flex justify-center items-center cursor-pointer" onClick={handleSubstractClicked}>-</div>
            </div>
