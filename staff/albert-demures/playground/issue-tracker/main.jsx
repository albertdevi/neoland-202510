...
function App() {
    ...
    const headerStyles = {
        Open: 'flex items-center px-2 py-3 bg-gradient-to-r from-green-700 to-green-600 rounded-t-2xl gap-5 rounded-t-xl text-white border-b-4 border-b-green-300',
        OnHold: 'flex items-center px-2 py-3 bg-gradient-to-r from-red-700 to-red-600 rounded-t-2xl gap-5 rounded-t-xl text-white border-b-4 border-b-red-300',
        InProgress: 'flex items-center px-2 py-3 bg-gradient-to-r from-yellow-700 to-yellow-600 rounded-t-2xl gap-5 rounded-t-xl text-white border-b-4 border-b-yellow-300',
        Done: 'flex items-center px-2 py-3 bg-gradient-to-r from-blue-700 to-blue-600 rounded-t-2xl gap-5 rounded-t-xl text-white border-b-4 border-b-blue-300'
    }

    //Constante array que define el estilo de los botones del header según el estado.
    const buttonStyles = {
        Open: 'flex items-center bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-2 border border-green-700 rounded-full text-xs font-semibold shadow-sm ml-auto',
        OnHold: 'flex items-center bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-2 border border-red-700 rounded-full text-xs font-semibold shadow-sm ml-auto',
        InProgress: 'flex items-center bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-2 border border-yellow-700 rounded-full text-xs font-semibold shadow-sm ml-auto',
        Done: 'flex items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-2 border border-blue-700 rounded-full text-xs font-semibold shadow-sm ml-auto'
    }
...
const handleDeleteIssueClick = (event, issueId) => {
    ...
    return <div className="max-w-5xl mx-auto p-2 flex flex-col gap-6">
        <h1 className="text-3xl md:text-4xl font-extrabold text-center text-gray-800 mt-4">GBK Issues 📋</h1>
        ...
        <div className=" border border-gray-200 shadow-lg p-4 rounded-2xl bg-white">
